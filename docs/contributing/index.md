...
- **[Releasing](releasing.md)** — tag flow + one-time PyPI trusted-publisher setup.
...
- [`.claude/rules/quality-python.md`](https://github.com/ocx-sh/ocx-sdk-python/blob/main/.claude/rules/quality-python.md) — Python 3.12+
